...
class Charge
{
     ...
     *
     * @var \LinkThrow\Billing\Gateways\ChargeInterface
     */
    protected $charge;
     ...
     * @param \LinkThrow\Billing\Gateways\ChargeInterface $charge
     * 
     * @return void
     */
    public function __construct(\Illuminate\Database\Eloquent\Model $model, \LinkThrow\Billing\Gateways\ChargeInterface $charge)
    {
        $this->model = $model;
        $this->charge = $charge;
