<?php namespace LinkThrow\Billing\CustomerBillableTrait;
...
class InvoiceItem
{
     ...
     *
     * @var \LinkThrow\Billing\Gateways\InvoiceInterface
     */
    protected $invoice;
     ...
     * @param \LinkThrow\Billing\Gateways\InvoiceInterface $invoice
     * @param array                                     $item
     * 
     * @return void
     */
    public function __construct(\Illuminate\Database\Eloquent\Model $model, \LinkThrow\Billing\Gateways\InvoiceInterface$invoice, array $item)
    {
        $this->model = $model;
